...
template <class T, class U, class B = op_detail::empty_base<T> >
...
template <class T, class B = op_detail::empty_base<T> >
...
template <class T, class P, class B = op_detail::empty_base<T> >
...
template <class T, class I, class R, class B = op_detail::empty_base<T> >
struct indexable : B
{
...
template <class T, class P, class D, class R, class B = op_detail::empty_base<T> >
...
template<class T> struct is_chained_base {
  typedef op_detail::false_t value;
};
...
# define BOOST_OPERATOR_TEMPLATE4(template_name4)           \
  ...
  struct is_chained_base< template_name4<T, U, V, W, B> > { \
    typedef op_detail::true_t value;                        \
  };
...
template <class T                                                 \
         ,class U = T                                             \
         ,class B = op_detail::empty_base<T>                      \
         ,class O = typename is_chained_base<U>::value            \
         >                                                        \
struct template_name;                                             \
                                                                  \
template<class T, class U, class B>                               \
struct template_name<T, U, B, op_detail::false_t>                 \
  : template_name##2<T, U, B> {};                                 \
                                                                  \
template<class T, class U>                                        \
struct template_name<T, U, op_detail::empty_base<T>, op_detail::true_t> \
  : template_name##1<T, U> {};                                    \
                                                                  \
template <class T, class B>                                       \
struct template_name<T, T, B, op_detail::false_t>                 \
  : template_name##1<T, B> {};                                    \
                                                                  \
